...
import { PropsWithMovieCards, getMoviesData, getTotalPages, movieBySearchResult } from "../utils";
...
const SearchPage = ({ movies, total_pages, page }: PropsWithMovieCards<Props>) => {
  const router = useRouter();
  const { query } = router.query;
  const [isXs] = useWindowSize();
  return (
    <div className="container mt-24 flex min-h-[60vh]  flex-col items-center px-0 pb-10 md:mt-32">
